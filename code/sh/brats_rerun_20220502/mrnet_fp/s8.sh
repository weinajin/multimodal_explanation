...
cd /project/labname-lab/authorid/BRATS_IDH/code
python xai_mrnet.py --machine solar -c /project/labname-lab/authorid/shortcut/BRATS_IDH/code/sh/mrnet_gethm/mrnet_xai_solar.json --model_path /project/labname-lab/authorid/ --seed $SEED --job fp |& tee -a /project/labname-lab/authorid/brats_rerun/s8_fp_mrnet.txt