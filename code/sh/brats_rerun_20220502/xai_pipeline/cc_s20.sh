...
python xai_pipeline.py --config sh/xai_cc_plain2_BRATS_HGG.json --fold 1 --seed $SEED --bs 1 --ts cc --job pipeline_nogethm -r /scratch/authorid/results_brats_rerun/heatmaps/seed_20/ |& tee -a /scratch/authorid/results_brats_rerun/heatmaps/log/s20.txt
