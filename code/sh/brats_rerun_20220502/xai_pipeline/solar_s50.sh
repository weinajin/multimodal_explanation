...
cd /project/labname-lab/authorid/BRATS_IDH/code
python xai_pipeline.py --config sh/xai_solar_plain2_BRATS_HGG.json --fold 1 --seed $SEED --bs 1 --ts solar --job pipeline -r /project/labname-lab/authorid/brats_rerun/BRATS_HGG/s50_hm_fold_1/ |& tee -a /project/labname-lab/authorid/brats_rerun/BRATS_HGG/s50_hm_fold_1/s50_ppl.txt
