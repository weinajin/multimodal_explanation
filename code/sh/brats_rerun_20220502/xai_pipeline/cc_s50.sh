...
#SBATCH --job-name s50-acc_drop_bgnb
...
python xai_pipeline.py --config sh/xai_cc_plain2_BRATS_HGG.json --fold 1 --seed $SEED --bs 1 --ts cc --job acc_drop_bgnb -r /scratch/authorid/results_brats_rerun/heatmaps/seed_50/ |& tee -a /scratch/authorid/results_brats_rerun/heatmaps/log/s50_acc_drop_bgnb.txt
