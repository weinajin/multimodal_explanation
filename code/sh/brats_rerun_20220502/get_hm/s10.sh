...
python xai_pipeline.py --config sh/xai_cc_plain2_BRATS_HGG.json --fold 1 --seed $SEED --bs 1 --ts cc --job gethm -r /scratch/authorid/brats_rerun/BRATS_HGG/0506_173002_fold_1_seed_10/
