...
python xai_pipeline.py --config sh/xai_cc_plain2_BRATS_HGG.json --fold 1 --seed $SEED --bs 1 --ts cc --job gethm  -r /scratch/authorid/brats_rerun/BRATS_HGG/0507_215508_fold_1_seed_50/
