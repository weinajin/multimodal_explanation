...
python xai_pipeline.py --config sh/xai_cc_plain2_BRATS_HGG.json --fold 1 --seed $SEED --bs 1 --ts cc --job fp_iou -r /scratch/authorid/results_brats_rerun/heatmaps/seed_${SEED}/ |& tee -a /scratch/authorid/results_brats_rerun/heatmaps/log/s${SEED}_fp_iou.txt
