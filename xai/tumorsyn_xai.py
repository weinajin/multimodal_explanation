...
def tumorsyn_get_test_performance(config):
    ...
    test(config, image_label = image_label, timestamp = True,
         save_inputs=test_input_save_dir,
    ...
    if not val_dataset :
        ...
        test(config, image_label = image_label, timestamp = True,
             save_inputs=first_input_save_dir,
             val_first_gt_align_prob=1,
        ...
        test(config, image_label = image_label, timestamp = True,
             save_inputs=second_input_save_dir,
...
def tumorsyn_get_hm(config, machine = 'ts',
                    saved_dir = "maskedname/trained_model/tumorsyn/7/test/get_hm_input"
                    # saved_dir="/local-scratch/maskedname/trained_model/tumorsyn/7/test/20210528_1919"
                    ):
    if machine == 'solar':
        root = '/project/mial-lab/'
...
def tumorsyn_results(gt_attr = [0,0,1,0], ABS= False, iou= False,
                     input_dir = "/local-scratch/maskedname/trained_model/tumorsyn/7/test/20210528_1919",
                     hm_dir = "/local-scratch/maskedname/tumorsyn/log/tumorsyn/gethm_fold_7/tumorsyn_get_hm_fold_7_fold_7/heatmap"):
