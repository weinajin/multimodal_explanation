...
def generate_hm_filename(data_id, xai_name, target, pred, gt):
...
def generate_heatmap_dataset(dataloader, model, save_dir, method_list, device,  image_key = 'image', last_layer = None):#, exp_condition = None, save_input = False):
    '''
...
def pipeline():
    ...
    if data_root == 'cc':
        ...
        model_file = '/local-scratch/maskedname/BRATS_IDH/log/0122_pattern_10epoch/fold_1_epoch_9.pth'
    else:
